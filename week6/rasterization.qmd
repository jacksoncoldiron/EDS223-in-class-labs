...
# Apply NDWI functino to landsat bands 3 & 4
ndwi_rast <- lapp(L7[[c(2, 4)]], 
                  fun = ndwi_fun)
...
Normalized Difference Moisture Index: veg index used in remote sensing used ot measure and monitor the water content in vegetation

NDMI = (NIR - SWIR) / (NIR + SWIR)

- Measure moisture wihtin plant levels:
    - HIgher valeus = more water content in vegetation
...
tmap_arrange(map1, map3, map_ndmi)
```
