...
```{r}
# Plot NZ with Canterbury shaded with highest elevations in points
tm_shape(nz) +
  tm_polygons() +
  tm_shape(canterbury) +
...
```{r}
# Sparse binary predicate list (empty or 1)
...
regions2 <- aggregate(x = us_states[, "total_pop_15"], #data to be aggregateed
